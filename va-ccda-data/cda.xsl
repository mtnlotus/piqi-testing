...
<!--
             ************************************************************************************************************************
             Veterans Data Integration and Federation Enterprise Platform (VDIF-EP) CDA STYLESHEET JHIE 4.14, Release Date 07/10/2025
             ************************************************************************************************************************
             NOTE:
             * DO NOT EDIT this file in Studio.
             * EDIT using VS or ATOM Editor.
                               ...
                               <xsl:if test="not(n1:id/@nullFlavor)">
                                    ...
                                    <!--<xsl:call-template name="show-external-contactInfo-telecom">
                                      <xsl:with-param name="external-contact-telecom" select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole"/>
											...
											<tr valign="top">
												<th>Telephone and Email</th>
												<td>
													<xsl:choose>
														<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='HP']">
															<xsl:value-of select="concat('Primary Home: ', substring-after(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='HP']/@value, 'tel:'))" />
														</xsl:when>
														<xsl:otherwise>
													...
													<br />
													<xsl:choose>
														<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='HV']">
															<xsl:value-of select="concat('Vacation Home: ', substring-after(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='HV']/@value, 'tel:'))" />
														</xsl:when>
														<xsl:otherwise>
													...
													<br />
													<xsl:choose>
														<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='WP']">
															<xsl:value-of select="concat('Work: ', substring-after(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='WP']/@value, 'tel:'))" />
														</xsl:when>
														<xsl:otherwise>
													...
													<br />
													<xsl:choose>
														<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='MC']">
															<xsl:value-of select="concat('Mobile: ', substring-after(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@use='MC']/@value, 'tel:'))" />
														</xsl:when>
														<xsl:otherwise>
													...
													<br />
													<xsl:choose>
														<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[contains(@value,'mailto:')]">
															<xsl:value-of select="concat('Email: ', substring-after(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[contains(@value,'mailto:')]/@value, 'mailto:'))" />
														</xsl:when>
														<xsl:otherwise>
